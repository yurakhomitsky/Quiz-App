...
import { getStyleByScore, getTitleByScore } from '../../shared/utils/utils.functions';
...
export class QuizComponent implements OnInit {
  ...
  private calculateScore(mapAnswer: Answer, mapQuestion: { [key: number]: Question }): Score {
    ...
    const scoreInPercent = +((numberOfTrueAnswers / this.questions.length) * 100).toFixed();
